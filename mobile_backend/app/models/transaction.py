...
class FinanceRecord(BaseModel):
    ...
    transactionID: Optional[int | str] = Field(None, description="Transaction ID")
    ...
    userID: Optional[int | str] = Field(None, description="User ID associated with the transaction")
