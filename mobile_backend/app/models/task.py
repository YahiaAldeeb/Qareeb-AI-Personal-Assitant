...
class TaskRecord(BaseModel):
    ...
    taskID: Optional[int | str] = Field(None, description="Task ID")
    userID: Optional[int | str] = Field(None, description="User ID associated with the task")
    ...
    created_at: Optional[str] = Field(None, description="Creation date in ISO format")
    updated_at: Optional[str] = Field(None, description="Last update date in ISO format")
